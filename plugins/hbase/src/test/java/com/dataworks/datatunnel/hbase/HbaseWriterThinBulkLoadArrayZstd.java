...
/****************************************
 * @@CREATE : 2021-08-30 8:21 下午
 * @@AUTH : NOT A CAT【NOTACAT@CAT.ORZ】
 * @@DESCRIPTION :
 * @@VERSION :
 *****************************************/
public class HbaseWriterThinBulkLoadArrayZstd {
//        create 'bulkLoadTest5', {NAME=>'f1', VERSIONS=>5},SPLITS => ['1', '3', '5', '7']
//        get 'bulkLoadTest5','1',{COLUMN=>'f1',VERSIONS=>5}

    @Test
    public void thinBulkLoadArrayZstd() throws Exception{
        String table = "bulkLoadTest5";
        String stagingDir = "20210828010";
        ...
        map.put("mappingMode", MappingMode.arrayZstd.name());
