 ...
 * @@VERSION :
 *****************************************/
public class HbaseWriterBulkLoadOne2One {
//        create 'bulkLoadTest2', {NAME=>'f1', VERSIONS=>5},SPLITS => ['1', '3', '5', '7']
//        get 'bulkLoadTest2','1',{COLUMN=>'f1',VERSIONS=>5}

    @Test
    public void bulkLoadOne2One() throws Exception{
