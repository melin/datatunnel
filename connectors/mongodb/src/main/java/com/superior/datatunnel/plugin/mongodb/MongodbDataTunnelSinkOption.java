...
public class MongodbDataTunnelSinkOption extends BaseSinkOption {
    ...
    @OptionDesc("Field or list of fields by which to split the collection data. To specify more than one field, separate them using a comma as shown in the following example: fieldName1,fieldName2 ")
    private String idFieldList = "_id";

    @OptionDesc("When true, the connector ignores any null values when writing, including null values in arrays and nested documents.")
    ...
    @OptionDesc("Specifies the type of write operation to perform. You can set this to one of the following values: insert, replace, update")
